window.addEventListener("load", function () {
    ...
    inputPassWord.addEventListener("input", function (e) {
        ...
        if (value.trim() === "") {
            ...
            const checkLength = document.querySelector(".check-length");
            const checkUpperClass = document.querySelector(".check-length");
            const checkNumberClass = document.querySelector(".check-length");
            const checkSpecialClass = document.querySelector(".check-length");
