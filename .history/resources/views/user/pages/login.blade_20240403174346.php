...
<body>
    <div class="header">
        <nav class=" container">         
            <!-- Logo desktop -->		
            <a href="{{route("All-Product")}}" class="logo">
    ...
    <div class="form-login">
        ...
        <form action="{{route("login-user")}}" method="POST">
            ...
            <div class="input-wrapper">
                <input type="text" name="account" class="input" placeholder="Your User Name" >
        ...
        <div class="link-register">
            <p class="link-tille">Bạn chưa có tài khoản <a href="{{route("register-view") }}" class="link">ĐĂNG KÍ </a>NGAY</p>
        </div>
