                            ...
                            <form action="{{url("/updateCart")}}" method="POST"> 
                                @csrf
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-4">
                                                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                    ...
                                                    <input class="mtext-104 cl3 txt-center num-product cart_quantity" type="number" name="cart_qty" value="{{$item["product_qty"]}}">
                                    ...
                                    <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                                        ...
                                        <input class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10" type="submit" value="Update Cart" name="update_qty" >
                                    </div>
                            </form>
						</div>
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" n  placeholder="State /  country">
									</div>
