                                ...
                                @csrf
                                    ...
                                    <table class="table-shopping-cart">
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-3"><a style="   display: flex; justify-content: center;
                                                
                                                align-items: center;" class=" bor13 hov-btn3  trans-04 pointer button-trash" href="{{url("/deleteProductCart/".$item["session_id"] )}}"><i class="fa fa-trash"></i></a> </td>
                                        </tr>
                                        @endforeach
                                        @endif
