        ...
        <div class="container">
            <nav aria-label="breadcrumb" >
                <ol class="breadcrumb"  style="background-color: #F2F2F2">
                    ...
                    <li class="breadcrumb-item active"><a href="/category/{{$breadcrumbCategory->id_category}}">{{$breadcrumbCategory->name_category}}</a></li>
            ...
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    <a href="/categoryProd/{{$item->id_cate_product }}" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5  " data-filter="*">
            ...
            <style>
                ...
                <p class="no-product" >sorry customers! There are currently no products</p>
            @endif
