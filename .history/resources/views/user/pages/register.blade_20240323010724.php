        ...
        <form action="{{route("login")}}" method="POST">
            ...
            <div class="input-wrapper">
                ...
                <div class="wrap-input100 validate-input m-b-0" data-validate = "Username is reauired">
                    ...
                    <input class="input100 input" type="text" name="acccount" placeholder="Nhập họ và tên"
                    >
                    <span class="focus-input100" data-symbol="&#xf206;"></span>
                </div>
                <div class="wrap-input100 validate-input m-b-0" data-validate = "Username is reauired">
                    <span class="label-input100">Mật khẩu</span>
                    <input class="input100 input" type="password" name="password" placeholder="Nhập họ và tên"
                    >
                ...
                <div class="wrap-input100 validate-input m-b-0" data-validate = "Username is reauired">
                    ...
                    <input class="input100 input" type="password" name="password-re" placeholder="Nhập họ và tên"
                    >
                ...
                <div class="wrap-input100 validate-input m-b-0" data-validate = "Username is reauired">
                    ...
                    <input class="input100 input" type="number" name="user_name" placeholder="Nhập họ và tên"
                    >
                    <span class="focus-input100" data-symbol="&#xf206;"></span>
                </div>
