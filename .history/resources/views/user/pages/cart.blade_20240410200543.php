				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl"> 
						<div class="wrap-table-shopping-cart">
                            @if(session('message'))
                            <span  style="color:#28a745; width: 250px;">{{ session('message') }}</span>
                            @endif
                            @if(session('error'))
                            ...
                            <form action="{{route("update-Cart")}}" method="POST"> 
                                @csrf
                                    ...
                                    <table class="table-shopping-cart">
                                        <tr class="table_head">
                                            <th class="column-3"  style="" >Product</th>
                                        ...
                                        @if ($cart=="")
                                        <tr class="table_row">
                                            <td colspan="6" style="text-align: center" > No Product in Cart <a href="{{route("All-Product")}}"> Back Now</a></td>
                                        </tr>
                                        ...
                                        <tr class="table_row">
                                            ...
                                            <td class="column-5"> {{(number_format( $sub, 0, '.', '.') . ' VNĐ')}}</td>
                                            <td class="column-3"><a style="   display: flex; justify-content: center;align-items: center;"                                        
                                       class=" bor13 hov-btn3  trans-04 pointer button-trash" href="{{url("/deleteProductCart/".$item["session_id"] )}}"><i class="fa fa-trash"></i></a> </td>
                                        </tr>
                                        @endforeach
                                        @endif
                                    ...
                                    <a   class="  bor13 hov-btn3 p-lr-10 trans-04 pointer button-a " href="{{route("removeAll")}}"> Remove All Product In Cart</a>  
                                    <input   class="  bor13 hov-btn3 p-lr-10 trans-04 pointer"   type="submit"  value="Update Cart"  > 
                                ...
                                <div  >      
                                    ...
                                    <form action="{{route("check-coupon")}}" autocomplete="off" method="post">                 
                                        @csrf        
