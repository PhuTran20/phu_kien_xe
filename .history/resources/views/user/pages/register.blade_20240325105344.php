    ...
    <div class="form-login">
        ...
        <form action="{{route("register-user")}}" class="form" method="POST" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="user_name" placeholder="Enter Password" class="form-control">
                <span class="form-message"></span>
            </div> <div class="form-group">
                <label for="Re-Password" class="form-lable">Full Name</label>
                <input type="text" name="user_name" placeholder="Enter again password" class="form-control">
                <span class="form-message"></span>
            </div> <div class="form-group">
                <label for="Full Name" class="form-lable">Full Name</label>
                <input type="text" name="user_name" placeholder="E.g: Phu Tran " class="form-control">
