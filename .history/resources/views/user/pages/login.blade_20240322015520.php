...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{url('frontend')}}/js/pages/login.css">
    ...
    <div class="form-login">
        ...
        <form action="{{route("login")}}" method="POST">
            ...
            <div class="input-wrapper">
                <input type="text" name="user_name" class="input" placeholder="Your User Name" id="">
                <input type="password" name="password" class="input input-password" placeholder="Your PassWord" id="">
                <i class="fa fa-eye toggle"></i>
            </div>
            <button type="submit" class="btn-submit">LOGIN</button>
        </form>
        <div class="link-register">
            <p class="link-tille">Bạn chưa có tài khoản <a href="{{route{""}}}" class="link">ĐĂNG KÍ </a>NGAY</p>
        </div>
