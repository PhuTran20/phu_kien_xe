                           ...
                           @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_cate_product"  id="id_cate_product" class="form-control id_cate_product choose">
                                    <option value="{{$product->id_cate_product}} ">{{$product->name_Product_Cate}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <input     name="descriptions" value="{{$product->descriptions}}" type="text" class="form-control input" id="Descriptions"   >                                                                                                     
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input   placeholder="E.g: 10" value="{{$product->quantity}}"  name="quantity" type="text" class="form-control input" id="Quantity"   >                                                                                                     
                            </div>
                            <div class="form-group">
                                <p>Suitable car model</p> 
                         
                                   <input class="bike-checkbox " type="checkbox" name="name_bike[]" id="" value="{{$product->name_bike}}"> 
                                   <label class="name-bike" for="bike{{$item->id_bike}}" style="display: inline">{{$product->name_bike}} </label>
