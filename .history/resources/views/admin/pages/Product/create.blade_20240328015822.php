                        ...
                        <form method="post" class="form-main" action="{{route("admin-store-product")}}" enctype="multipart/form-data" autocomplete="off" >
                           @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input    name="image" type="text" class="form-control input" id="Image"   >                                                                                                     
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label  for="Suitable car model">Suitable car model</label>              
                                <input   placeholder="E.g: Exciter "  name="id_bike" type="text" class="form-control input" id="Suitable car model"   >                                                                                                     
                            </div>
                            <div class="form-group">
                                <label  for="id_cate_product Product">Category Product</label>              
                                <input   placeholder="E.g: Nhớt "  name="id_cate_product" type="text" class="form-control input" id="id_cate_product"   >                                                                                                     
                            </div>
