                        ...
                        <table  class="table table-striped table-bordered"> 
                            ...
                            ?>            
                                <tr>
                                    ...
                                    <td class="image-prod" style="width: 200px;height: 200px;" ><img   style=" border-radius: 0;     width: 100%;
    height: 100%;" src="{{ URL::to('/frontend/images/'.$item->image)}}" alt=""></td>
                                    <td class="detail"> <button class="btn btn-info "> <i class="fa fa-eye"></i> </button> </td>
