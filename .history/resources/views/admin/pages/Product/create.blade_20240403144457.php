                        ...
                        <form method="post" class="form-main" action="{{route("admin-store-product")}}" enctype="multipart/form-data" autocomplete="off" >
                           @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input   placeholder="E.g: Dầu nhớt xe máy MOTUL 7100 4T 10W50 1L "  name="name_product" type="text" value="{{old("name_product")}}" class="form-control input" id="name"   >                                                                                                     
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="price"  value="{{old("name_product")}}" type="text" class="form-control input" id="Price" onkeyup="formatCurrency(this);">
                            </div>
                            
                            <div class="form-group">
                                <label  for="Descriptions">Descriptions</label>              
                                <input   value="{{old("name_product")}}"   name="descriptions" type="text" class="form-control input" id="Descriptions"   >                                                                                                     
                            </div>
                            <div class="form-group">
                                <label  for="Image">Image</label>              
                                <input   value="{{old("name_product")}}"  name="image" type="file" class="form-control input" id="Image"   >                                                                                                     
                            </div>
                            <div class="form-group">
                                <label  for="Quantity">Quantity</label>              
                                <input  value="{{old("name_product")}}"   placeholder="E.g: 10"  name="quantity" type="text" class="form-control input" id="Quantity"   >                                                                                                     
                            </div>
                            <div class="form-group">
                                <p>Suitable car model</p> 
                               @foreach ($bike as $item)
                                   <input class="bike-checkbox " type="checkbox" name="name_bike[]" id="bike{{$item->id_bike}}" value="{{$item->name_bike}}"> 
