                           ...
                           @csrf
                            ...
                            <div class="form-group">
                               ...
                               @foreach ($bike as $item)
                                   <input class="bike-checkbox " type="checkbox" name="id_bike" id="bike{{$item->id_bike}}" value="{{$item->id_bike}}"> <label for="check" style="display: inline">{{$item->name_bike}} </label>
                               @endforeach                                                                                                 
                            </div>
                            <div class="form-group">
