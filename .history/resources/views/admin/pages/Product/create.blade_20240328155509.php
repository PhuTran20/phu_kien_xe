                        ...
                        <form method="post" class="form-main" action="{{route("admin-store-product")}}" enctype="multipart/form-data" autocomplete="off" >
                           @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input    name="image" type="file" class="form-control input" id=""   >                                                                                                     
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                               ...
                               @foreach ($bike as $item)
                                   <input class="bike-checkbox " type="checkbox" name="id_bike" id="bike{{$item->id_bike}}" value="{{$item->id_bike}}"> <label class="name-bike" for="bike{{$item->id_bike}}" style="display: inline">{{$item->name_bike}} </label>
                               @endforeach                                                                                                 
                            </div>
                            <div class="form-group">
