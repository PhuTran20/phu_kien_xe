                    ...
                    <div class="panel-body">
                        <form method="post" class="form-main" action="{{route("admin-store-Coupon")}}" enctype="multipart/form-data" autocomplete="off" >
                           @csrf
                            ...
                            <div class="form-group">
                                <label  for="name">Enter the discount percentage or discount amount:</label>              
                                <input   placeholder="E.g: Sale Event 30/4 - 1/5"  name="coupon_number" type="text" value="{{old("coupon_number")}}" class="form-control input" id="name"   >                                                                                                     
                            </div>
