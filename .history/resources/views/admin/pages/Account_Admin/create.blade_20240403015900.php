                        ...
                        <form method="post" class="form-main" action="{{route("admin-store-account")}}" enctype="multipart/form-data" autocomplete="off" >
                           @csrf
                            <div class="form-group">
                                ...
                                <input   placeholder="E.g: Phu Tran "  name="name_category" type="text" class="form-control input" id="name"   >                                   
                            </div>
                            <div class="form-group">
                                <label  for="name">Account Admin:</label>              
                                <input   placeholder="E.g: admin1 "  name="name_category" type="text" class="form-control input" id="name"   >                                   
                            </div>
                            <div class="form-group">
