...
<head>
  ...
  <link rel="stylesheet" href="{{url('backend')}}/frontend-admin/css/admin_product/index.css">
...
<script src="{{url('backend')}}/frontend-admin/js-custom/product/index.js"></script>
            ...
            if (id_category) {
                $.ajax({
                    ...
                    success: function(res) {
                        if (res) {
                            $("#id_cate_product").empty();
                            $("#id_cate_product").append('<option value="">Select Category Product</option>');
                            $.each(res, function(key, value) {
                                $("#id_cate_product").append('<option value="' + key + '">' + value + '</option>');
                            });
                        } else {
                            $("#id_cate_product").empty();
                        }
