...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/product/edit/{id_product}",[CategoryProdController::class,"viewEdit"]);
    Route::put("/product/update/{id_product}",[CategoryProdController::class,"updateCategoryProd"]);
    Route::delete("/product/delete/{id_product}",[CategoryProdController::class,"destroyCategoryProd"]);
});