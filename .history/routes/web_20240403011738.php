...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/accountcreate",[BikeController::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/accountstore",[BikeController::class,"storebike"])->name("admin-store-bike");
    Route::get("/accountedit/{id_bike}",[BikeController::class,"viewEdit"]);
    Route::put("/accountupdate/{id_bike}",[BikeController::class,"updatebike"]);
    Route::delete("/accountdelete/{id_bike}",[BikeController::class,"destroybike"]);
