...
Route::prefix('admin')->group( function (){
    ...
    //account-admin
    Route::get("/account",[A::class,"viewIndex"])->name("admin-admin");
    Route::get("/account/create",[A::class,"viewCreate"])->name("admin-create-admin");
    Route::post("/account/store",[A::class,"storeAdmin"])->name("admin-store-admin");
    Route::get("/account/edit/{id_admin}",[A::class,"viewEdit"]);
    Route::put("/account/update/{id_admin}",[A::class,"updateAdmin"]);
    Route::delete("/account/delete/{id_admin}",[A::class,"destroyAdmin"]);
