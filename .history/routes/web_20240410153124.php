...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/coupon/edit/{id_bike}",[BikeController::class,"viewEdit"]);
    Route::put("/coupon/update/{id_bike}",[BikeController::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_bike}",[BikeController::class,"destroybike"]);
    //account-admin
