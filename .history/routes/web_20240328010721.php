...
Route::prefix('admin')->group( function (){
    ...
    //bike
    Route::get("/bike",[B::class,"viewIndex"])->name("admin-product");
    Route::get("/bike/create",[B::class,"viewCreate"])->name("admin-create-product");
    Route::post("/bike/store",[B::class,"storeProduct"])->name("admin-store-product");
    Route::get("/bike/edit/{id_bike}",[B::class,"viewEdit"]);
    Route::put("/bike/update/{id_bike}",[B::class,"updateProduct"]);
    Route::delete("/bike/delete/{id_bike}",[B::class,"destroyProduct"]);
});