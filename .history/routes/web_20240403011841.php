...
Route::prefix('admin')->group( function (){
    ...
    //account-admin
    Route::get("/account",[AdminController::class,"viewIndex"])->name("admin-admin");
    Route::get("/account/create",[AdminController::class,"viewCreate"])->name("admin-create-admin");
    Route::post("/account/store",[AdminController::class,"storeAdmin"])->name("admin-store-admin");
    Route::get("/account/edit/{id_admin}",[AdminController::class,"viewEdit"]);
    Route::put("/account/update/{id_admin}",[AdminController::class,"updateAdmin"]);
    Route::delete("/account/delete/{id_admin}",[AdminController::class,"destroyAdmin"]);
