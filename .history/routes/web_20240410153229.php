...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[CouponController::class,"viewIndex"])->name("admin-bike");
    Route::get("/coupon/create",[CouponController::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/coupon/store",[CouponController::class,"storebike"])->name("admin-store-bike");
    Route::get("/coupon/edit/{id_coupon}",[CouponController::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[CouponController::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_coupon}",[CouponController::class,"destroybike"]);
    //account-admin
