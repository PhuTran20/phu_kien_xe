...
Route::prefix('admin')->group( function (){
    ...
    //category-product
    Route::get("/category_Prod",[Category_Prod::class,"viewIndex"])->name("admin-category");
    Route::get("/category/create",[Category_Prod::class,"viewCreate"])->name("admin-create-category");
    Route::post("/category/store",[Category_Prod::class,"storeCategory"])->name("admin-store-category");
    Route::get("/category/edit/{id_category}",[Category_Prod::class,"viewEdit"])->name("admin-edit-category");
    Route::put("/category/update/{id_category}",[Category_Prod::class,"updateCategory"])->name("admin-update-category");
    Route::delete("/category/delete/{id_category}",[Category_Prod::class,"destroyCategory"]);
});