...
Route::prefix('admin')->group( function (){
    ...
    //category-product
    Route::get("/category_Prod",[CategoryProdController::class,"viewIndex"])->name("admin-category");
    Route::get("/category_Prod/create",[CategoryProdController::class,"viewCreate"])->name("admin-create-category");
    Route::post("/category_Prod/store",[CategoryProdController::class,"storeCategory"])->name("admin-store-category");
    Route::get("/category_Prod/edit/{id_category}",[CategoryProdController::class,"viewEdit"])->name("admin-edit-category");
    Route::put("/category_Prod/update/{id_category}",[CategoryProdController::class,"updateCategory"])->name("admin-update-category");
    Route::delete("/category_Prod/delete/{id_category}",[CategoryProdController::class,"destroyCategory"]);
});