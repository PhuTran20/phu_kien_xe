...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[CartController::class,"viewIndex"])->name("admin-bike");
    Route::get("/coupon/create",[CartController::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/coupon/store",[CartController::class,"storebike"])->name("admin-store-bike");
    Route::get("/coupon/edit/{id_coupon}",[CartController::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[CartController::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_coupon}",[CartController::class,"destroybike"]);
    //account-admin
