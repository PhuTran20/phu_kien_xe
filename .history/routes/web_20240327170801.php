...
Route::prefix('admin')->group( function (){
    ...
    //category-product
    Route::get("/category_Prod",[Categor::class,"viewIndex"])->name("admin-category");
    Route::get("/category/create",[Categor::class,"viewCreate"])->name("admin-create-category");
    Route::post("/category/store",[Categor::class,"storeCategory"])->name("admin-store-category");
    Route::get("/category/edit/{id_category}",[Categor::class,"viewEdit"])->name("admin-edit-category");
    Route::put("/category/update/{id_category}",[Categor::class,"updateCategory"])->name("admin-update-category");
    Route::delete("/category/delete/{id_category}",[Categor::class,"destroyCategory"]);
});