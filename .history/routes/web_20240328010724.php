...
Route::prefix('admin')->group( function (){
    ...
    //bike
    Route::get("/bike",[BikeController::class,"viewIndex"])->name("admin-product");
    Route::get("/bike/create",[BikeController::class,"viewCreate"])->name("admin-create-product");
    Route::post("/bike/store",[BikeController::class,"storeProduct"])->name("admin-store-product");
    Route::get("/bike/edit/{id_bike}",[BikeController::class,"viewEdit"]);
    Route::put("/bike/update/{id_bike}",[BikeController::class,"updateProduct"]);
    Route::delete("/bike/delete/{id_bike}",[BikeController::class,"destroyProduct"]);
});