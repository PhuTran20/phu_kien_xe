...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/account/edit/{id_bike}",[BikeController::class,"viewEdit"]);
    Route::put("/account/update/{id_bike}",[BikeController::class,"updatebike"]);
    Route::delete("/account/delete/{id_bike}",[BikeController::class,"destroybike"]);
