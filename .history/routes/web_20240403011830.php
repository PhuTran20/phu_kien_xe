...
Route::prefix('admin')->group( function (){
    ...
    //account-admin
    Route::get("/account",[BikeController::class,"viewIndex"])->name("admin-admin");
    Route::get("/account/create",[BikeController::class,"viewCreate"])->name("admin-create-admin");
    Route::post("/account/store",[BikeController::class,"storeAdmin"])->name("admin-store-admin");
    Route::get("/account/edit/{id_admin}",[BikeController::class,"viewEdit"]);
    Route::put("/account/update/{id_admin}",[BikeController::class,"updateAdmin"]);
    Route::delete("/account/delete/{id_admin}",[BikeController::class,"destroyAdmin"]);
