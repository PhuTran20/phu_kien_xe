...
Route::prefix('admin')->group( function (){
    ...
    Route::post("/account/store",[AdminController::class,"storeAdmin"])->name("admin-store-account");
    Route::get("/account/edit/{id_admin}",[AdminController::class,"viewEdit"]);
    Route::put("/account/update/{id_admin}",[AdminController::class,"accountaccount"]);
