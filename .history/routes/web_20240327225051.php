...
Route::prefix('admin')->group( function (){
    ...
    //product
    Route::get("/product",[Pro::class,"viewIndex"])->name("admin-product");
    Route::get("/product/create",[Pro::class,"viewCreate"])->name("admin-create-product");
    Route::post("/product/store",[Pro::class,"storeProduct"])->name("admin-store-product");
    Route::get("/product/edit/{id_product}",[Pro::class,"viewEdit"]);
    Route::put("/product/update/{id_product}",[Pro::class,"updateProduct"]);
    Route::delete("/product/delete/{id_product}",[Pro::class,"destroyProduct"]);
});