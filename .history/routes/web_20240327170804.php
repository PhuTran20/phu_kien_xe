...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/category/create",[CategoryProdController::class,"viewCreate"])->name("admin-create-category");
    Route::post("/category/store",[CategoryProdController::class,"storeCategory"])->name("admin-store-category");
    Route::get("/category/edit/{id_category}",[CategoryProdController::class,"viewEdit"])->name("admin-edit-category");
    Route::put("/category/update/{id_category}",[CategoryProdController::class,"updateCategory"])->name("admin-update-category");
    Route::delete("/category/delete/{id_category}",[CategoryProdController::class,"destroyCategory"]);
});