...
Route::prefix('admin')->group( function (){
    ...
    //product
    Route::get("/product",[CategoryProdController::class,"viewIndex"])->name("admin-category-Prod");
    Route::get("/product/create",[CategoryProdController::class,"viewCreate"])->name("admin-create-categoryProd");
    Route::post("/product/store",[CategoryProdController::class,"storeCategoryProd"])->name("admin-store-categoryProd");
    Route::get("/product/edit/{id_cate_product}",[CategoryProdController::class,"viewEdit"]);
    Route::put("/product/update/{id_cate_product}",[CategoryProdController::class,"updateCategoryProd"]);
    Route::delete("/product/delete/{id_cate_product}",[CategoryProdController::class,"destroyCategoryProd"]);
});