...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[Ca::class,"viewIndex"])->name("admin-bike");
    Route::get("/coupon/create",[Ca::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/coupon/store",[Ca::class,"storebike"])->name("admin-store-bike");
    Route::get("/coupon/edit/{id_coupon}",[Ca::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[Ca::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_coupon}",[Ca::class,"destroybike"]);
    //account-admin
