...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/category/edit/{{$id_}}",[CategoryController::class,"viewEdit"])->name("admin-edit-category");
    Route::post("/category/update",[CategoryController::class,"updateCategory"])->name("admin-update-category");
});