...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/category_Prod/create",[CategoryProdController::class,"viewCreate"])->name("admin-create-category-Prod");
    Route::post("/category_Prod/store",[CategoryProdController::class,"storeCategory"])->name("admin-store-category-Prod");
