...
Route::prefix('user')->group(function () {
    Route::get('/login', [UserController::class, 'viewLogin'])->name('login-user');
    Route::get('/register', [UserController::class, 'viewRegister'])->name('register-user');
    Route::post('/register', [UserController::class, 'viewRegister'])->name('register-user');
});
