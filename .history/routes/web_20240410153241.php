...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[CouponController::class,"viewIndex"])->name("admin-C");
    Route::get("/coupon/create",[CouponController::class,"viewCreate"])->name("admin-create-C");
    Route::post("/coupon/store",[CouponController::class,"storeC"])->name("admin-store-C");
    Route::get("/coupon/edit/{id_coupon}",[CouponController::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[CouponController::class,"updateC"]);
    Route::delete("/coupon/delete/{id_coupon}",[CouponController::class,"destroyC"]);
    //account-admin
