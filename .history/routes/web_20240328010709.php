...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/bike/edit/{id}",[ProductController::class,"viewEdit"]);
    Route::put("/bike/update/{id}",[ProductController::class,"updateProduct"]);
    Route::delete("/bike/delete/{id}",[ProductController::class,"destroyProduct"]);
});