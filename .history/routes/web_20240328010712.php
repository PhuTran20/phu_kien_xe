...
Route::prefix('admin')->group( function (){
    ...
    Route::get("/bike/edit/{id_bike}",[ProductController::class,"viewEdit"]);
    Route::put("/bike/update/{id_bike}",[ProductController::class,"updateProduct"]);
    Route::delete("/bike/delete/{id_bike}",[ProductController::class,"destroyProduct"]);
});