...
Route::prefix('admin')->group( function (){
    ...
    //category-product
    Route::get("/category_Prod",[cATE::class,"viewIndex"])->name("admin-category");
    Route::get("/category/create",[cATE::class,"viewCreate"])->name("admin-create-category");
    Route::post("/category/store",[cATE::class,"storeCategory"])->name("admin-store-category");
    Route::get("/category/edit/{id_category}",[cATE::class,"viewEdit"])->name("admin-edit-category");
    Route::put("/category/update/{id_category}",[cATE::class,"updateCategory"])->name("admin-update-category");
    Route::delete("/category/delete/{id_category}",[cATE::class,"destroyCategory"]);
});