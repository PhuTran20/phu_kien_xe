...
Route::prefix('admin')->group( function (){
    ...
    Route::post("/category/ctore",[CategoryController::class,"storeCategory"])->name("admin-store-category");
    Route::get("/category/edit",[CategoryController::class,"storeCategory"])->name("admin-store-category");
    Route::post("/category/create",[CategoryController::class,"storeCategory"])->name("admin-store-category");
});