...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[::class,"viewIndex"])->name("admin-bike");
    Route::get("/coupon/create",[::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/coupon/store",[::class,"storebike"])->name("admin-store-bike");
    Route::get("/coupon/edit/{id_coupon}",[::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_coupon}",[::class,"destroybike"]);
    //account-admin
