...
Route::prefix('admin')->group( function (){
    ...
    //product
    Route::get("/product",[Prod::class,"viewIndex"])->name("admin-product");
    Route::get("/product/create",[Prod::class,"viewCreate"])->name("admin-create-product");
    Route::post("/product/store",[Prod::class,"storeProduct"])->name("admin-store-product");
    Route::get("/product/edit/{id_product}",[Prod::class,"viewEdit"]);
    Route::put("/product/update/{id_product}",[Prod::class,"updateProduct"]);
    Route::delete("/product/delete/{id_product}",[Prod::class,"destroyProduct"]);
});