...
Route::prefix('admin')->group( function (){
    ...
    //bike
    Route::get("/bike",[VB::class,"viewIndex"])->name("admin-product");
    Route::get("/bike/create",[VB::class,"viewCreate"])->name("admin-create-product");
    Route::post("/bike/store",[VB::class,"storeProduct"])->name("admin-store-product");
    Route::get("/bike/edit/{id_bike}",[VB::class,"viewEdit"]);
    Route::put("/bike/update/{id_bike}",[VB::class,"updateProduct"]);
    Route::delete("/bike/delete/{id_bike}",[VB::class,"destroyProduct"]);
});