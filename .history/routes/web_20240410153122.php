...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/",[BikeController::class,"viewIndex"])->name("admin-bike");
    Route::get("//create",[BikeController::class,"viewCreate"])->name("admin-create-bike");
    Route::post("//store",[BikeController::class,"storebike"])->name("admin-store-bike");
    Route::get("//edit/{id_bike}",[BikeController::class,"viewEdit"]);
    Route::put("//update/{id_bike}",[BikeController::class,"updatebike"]);
    Route::delete("//delete/{id_bike}",[BikeController::class,"destroybike"]);
    //account-admin
