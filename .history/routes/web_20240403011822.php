...
Route::prefix('admin')->group( function (){
    ...
    //account-admin
    Route::get("/account",[BikeController::class,"viewIndex"])->name("admin-bike");
    Route::get("/account/create",[BikeController::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/account/store",[BikeController::class,"storeAdmin"])->name("admin-store-bike");
