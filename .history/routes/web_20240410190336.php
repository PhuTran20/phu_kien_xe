...
Route::get("/categoryProd/{id_Product_Cate}",[ProductController::class,"showProductCategoryProduct"] );
...
//cart
Route::post("/add-cart-ajax",[CartController::class,"addCartAjax"])->name("addCart");
Route::get("/show-cart",[CartController::class,"showCart"])->name('shopping-cart');
Route::get("/show-cart",[CartController::class,"showCart"])->name('shopping-cart');
Route::post("/updateCart",[CartController::class,"updateCart"])->name('update-Cart');
Route::get("/deleteProductCart/{session_id}",[CartController::class,"deleteProductCart"]);
Route::get("/deleteProductCartAll",[CartController::class,"deleteProductCartAll"])->name("removeAll");
//coupon
...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[CouponController::class,"viewIndex"])->name("admin-Coupon");
    Route::get("/coupon/create",[CouponController::class,"viewCreate"])->name("admin-create-Coupon");
    Route::post("/coupon/store",[CouponController::class,"storeCoupon"])->name("admin-store-Coupon");
    Route::get("/coupon/edit/{id_coupon}",[CouponController::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[CouponController::class,"updateCoupon"]);
    Route::delete("/coupon/delete/{id_coupon}",[CouponController::class,"destroyCoupon"]);
    //account-admin
