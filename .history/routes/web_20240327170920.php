...
Route::prefix('admin')->group( function (){
    ...
    Route::put("/category_Prod/update/{id_cate_product}",[CategoryProdController::class,"updateCategory"]);
    Route::delete("/category_Prod/delete/{id_cate_product}",[CategoryProdController::class,"destroyCategory"]);
});