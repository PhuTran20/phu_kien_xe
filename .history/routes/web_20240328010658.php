...
Route::prefix('admin')->group( function (){
    ...
    //bike
    Route::get("/bike",[ProductController::class,"viewIndex"])->name("admin-product");
    Route::get("/bike/create",[ProductController::class,"viewCreate"])->name("admin-create-product");
    Route::post("/bike/store",[ProductController::class,"storeProduct"])->name("admin-store-product");
    Route::get("/bike/edit/{id_product}",[ProductController::class,"viewEdit"]);
    Route::put("/bike/update/{id_product}",[ProductController::class,"updateProduct"]);
    Route::delete("/bike/delete/{id_product}",[ProductController::class,"destroyProduct"]);
});