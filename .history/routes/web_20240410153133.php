...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[BikeController::class,"viewIndex"])->name("admin-bike");
    Route::get("/coupon/create",[BikeController::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/coupon/store",[BikeController::class,"storebike"])->name("admin-store-bike");
    Route::get("/coupon/edit/{id_coupon}",[BikeController::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[BikeController::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_coupon}",[BikeController::class,"destroybike"]);
    //account-admin
