...
Route::prefix('admin')->group( function (){
    ...
    //Coupon
    Route::get("/coupon",[Co::class,"viewIndex"])->name("admin-bike");
    Route::get("/coupon/create",[Co::class,"viewCreate"])->name("admin-create-bike");
    Route::post("/coupon/store",[Co::class,"storebike"])->name("admin-store-bike");
    Route::get("/coupon/edit/{id_coupon}",[Co::class,"viewEdit"]);
    Route::put("/coupon/update/{id_coupon}",[Co::class,"updatebike"]);
    Route::delete("/coupon/delete/{id_coupon}",[Co::class,"destroybike"]);
    //account-admin
