...
Route::prefix('admin')->group( function (){
    ...
    //account-admin
    Route::get("/account",[Ad::class,"viewIndex"])->name("admin-admin");
    Route::get("/account/create",[Ad::class,"viewCreate"])->name("admin-create-admin");
    Route::post("/account/store",[Ad::class,"storeAdmin"])->name("admin-store-admin");
    Route::get("/account/edit/{id_admin}",[Ad::class,"viewEdit"]);
    Route::put("/account/update/{id_admin}",[Ad::class,"updateAdmin"]);
    Route::delete("/account/delete/{id_admin}",[Ad::class,"destroyAdmin"]);
