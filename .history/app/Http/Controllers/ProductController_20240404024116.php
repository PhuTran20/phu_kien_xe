...
class ProductController extends Controller
{
    ...
    public function showProductCategoryProduct($id_cate_product){
        ...
        $breadcrumbCategoryProd = Product::join("category_product","category_product.id_cate_product","=","product.id_cate_product")
        ->where("category_product.id_category",$cate_prod->id_cate_product)->select("category.*","category_product.*")->first();
        dd($breadcrumbCategoryProd);
        $product = Product::join("category_product","category_product.id_cate_product","=","product.id_cate_product")
        ->where("product.id_cate_product",$id_cate_product)
        ->paginate("8");
        return view("user.pages.product-cate-prod")->with(compact("product"));
    }
