...
class AdminController extends Controller
{
    ...
    public function viewIndex(){
        ...
        return view("admin.pages.Account_Admin.index",["account_admin"=>$account_admin])->with(compact("account_admin"));
    }
    ...
    public function updateAccount(Request $request){
        ...
        DB::table("admin")->where( "id_admin",$request->id_admin)->update($update);
        return redirect("admin/account");

    }
    public function destroyAccount($id_admin){
        $account = Admin::find($id_admin);
        $account->delete();
        return redirect("admin/account");
    }
