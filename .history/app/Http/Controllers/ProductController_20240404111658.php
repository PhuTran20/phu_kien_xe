...
class ProductController extends Controller
{
    ...
    public function showProductCategoryProduct($id_cate_product ){
        ...
        $category = Category::join("category_product","category_product.id_cate_product","=","category.id_cate_product")
        ->where("category.id_cate_product",$cate_prod->id_cate_product)->select("category.*")->first();
        dd($category);
