...
class ProductController extends Controller
{
    ...
    public function showProductCategory($id_category){
        ...
        // $category_product =Category_Prod::all();
        $breadcrumbCategory = Category_Prod::join("category","category.id_category","=","category_product.id_category")
        ->where("category_product.id_category",$category->id_category)->select("category.*")->first();
    ...
    public function showProductCategoryProduct($id_cate_product){
        ...
        $breadcrumbCategoryProd =
         Product::join("category_product","category_product.id_cate_product","=","product.id_cate_product")
         ->join("category","category.id_category","=","product.id_category")
        ...
        ->get();
        $paginateProduct = $product->paginate("8");
        // dd($product);
        return view("user.pages.product-cate-prod")->with(compact("paginateProduct","product","breadcrumbCategoryProd"));
    }
