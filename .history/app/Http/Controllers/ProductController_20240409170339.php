...
class ProductController extends Controller
{
    ...
    public function showProductAll(Request $request){
        ...
        return view("user.pages.home")->with(compact("product","cate"));
    }
    ...
    public function showProductCategoryProduct($id_cate_product ){
        ...
        // dd($cate_prod);
        $category = Category::join("category_product","category_product.id_category","=","category.id_category")
        ->where("category.id_category",$cate_prod->id_category)->select("category.*")->first();
        // dd($category);
        $breadCate = Category_Prod::
        where("category_product.id_cate_product",$cate_prod->id_cate_product)
        ->select("category_product.*")->first();
        
   
        
        // $product2 = Product::join("category_product","category_product.id_cate_product","=","product.id_cate_product")
        ...
        // dd($product);
            ...
            return view("user.pages.product-cate-prod")->with(compact("product","category","breadCate"));
