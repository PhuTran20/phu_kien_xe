...
class ProductController extends Controller
{
    ...
    public function showProductDetail($id_product){
        ...
        ->where("product.id_product",$product_detail->id_product)->select("category.name_category")->first();
        $category_product = Product::join("category_product","category_product.id_cate_product","=","product.id_category")
        ->where("product.id_product",$product_detail->id_product)->select("category.name_Product_Cate")->first();
        dd($category,$category_product);
        // dd($product_detail);
