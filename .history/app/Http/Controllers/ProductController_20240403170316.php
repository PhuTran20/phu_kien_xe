...
class ProductController extends Controller
{
    ...
    public function showProductDetail($id_product){
        ...
        ->join("category_product","category_product.id_cate_product","=","product.id_cate_product")
        ->where("product.id_product",$product_detail->id_product)->select("category.name_category","category_product.name_Product_Cate")->first();
    ...
    public function showProductCategory($id_category){
        ...
        ->paginate("8");
        return view("user.pages.product")->with(compact("category","product","category_product"));
    }
    public function showProductCategoryProduct($id_cate_product){
        ...
        ->select("category_product.*")
        ->get();
        $productCate = Product::join("category_product","category_product.id_cate_product ","=","product.id_cate_product ")
        ->where("product.id_cate_product ",$id_cate_product)
        ->paginate("8");
        return view("user.pages.product-cate-prod")->with(compact("productCate","category","category_product"));
    }
