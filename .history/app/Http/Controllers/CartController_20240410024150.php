...
class CartController extends Controller
{
     ...
     public function updateCart(Request $request){
        $data = $request->input('cart_qty'); // Lấy dữ liệu số lượng gửi lên từ form
        $cart = Session::get("cart");
    
        if($cart){
            foreach($data as $session_id => $qty){ // Lặp qua mảng số lượng mới gửi lên từ form
        ...
        return redirect()->back(); // Chuyển hướng người dùng trở lại trang trước
    }
