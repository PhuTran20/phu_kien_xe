...
class ProductController extends Controller
{
    ...
    public function showProductCategoryProduct(Request $request){
        $cate_prod = Category_Prod::find($request->id_cate_product);
        ...
        $product = Product::join("category_product","category_product.id_cate_product","=","product.id_cate_product")
        ->where("product.id_cate_product",$request->id_cate_product)
