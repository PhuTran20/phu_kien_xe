...
class ProductController extends Controller
{
     ...
     */
    public function viewIndex(Product $product , $id_product)
    {
        // $id_bikes = $product->pluck('id_bike')->toArray();
        // $bike = Bike
        ...
        // return view("admin.pages.Product.index")->with(compact("product","id_bikes"));

        $bike = Product::join("bike","bike.id_bike","=","product.id_bike")
         ->where("product.id_product",$id_product)
         ->select("bike.*")->get();
        $product = Product::join("category_product","category_product.id_cate_product","=","product.id_product")
        ->select("product.*","category_product.*")->get();
        return view("admin.pages.Product.index")->with(compact())
    }
