...
class ProductController extends Controller
{
    ...
    public function viewIndex(Product $product)
    {
        ...
        // Lấy mảng id_bike từ bảng product
        $id_bikes = Product::pluck('id_bike')->toArray();
    
        // Lấy thông tin name_bike tương ứng với mỗi id_bike
        $bike_names = Bike::whereIn('id_bike', $id_bikes)->pluck('name_bike', 'id_bike');
    
        // Tiếp tục xử lý các phần còn lại của hàm
        ...
        $product = Product::join("category_product","category_product.id_cate_product","=","product.id_cate_product")
            ...
            ->select("product.*","category_product.*","bike.*")
            ->paginate(4);
      
        return view("admin.pages.Product.index")->with(compact("product", "bike",, "id_bikes" "bike_names"));
    }
