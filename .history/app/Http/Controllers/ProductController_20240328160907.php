...
class ProductController extends Controller
{
    ...
    public function storeProduct (Request $request){
        ...
        if ($request->has("image")) {
            ...
            $product->image = $file_name; // hoặc $product->image = '/frontend/img/' . $file_name;
        }
       ...
       if(is_array($id_bikes)) {
           $product->id_bike = implode(',', $id_bikes); // Chuyển mảng thành chuỗi và lưu vào cơ sở dữ liệu
       } else {
           $product->id_bike = $id_bikes; // Nếu không phải mảng, giữ nguyên giá trị chuỗi
       }
